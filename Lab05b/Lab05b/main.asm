...
;pwm
	ldi temp, 0b11111111
	out DDRE, temp ; set PL2 (OC3B) as output.
	
	ldi temp, 0x0 ; this value and the operation mode determine the PWM duty cycle
	sts OCR3BL, temp
	...
	; COM3B1=1: make OC5A override the normal port functionality of the I/O pin PL2
	sts TCCR3A, temp
	clr temp
